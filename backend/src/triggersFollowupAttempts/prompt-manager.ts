...
export async function getPromptContentByType(type: string): Promise<string> {
	...
	switch (type) {
		case "startviralFeaturespipedriveattempt":
			return prompt?.content ?? startviralFeatures_prompt;
		case "startviralBenefitspipedriveattempt":
			return prompt?.content ?? startviralBenefits_prompt;
		case "startviralGuidelinespipedriveattempt":
			return prompt?.content ?? startviralGuidelines_prompt;
		case "startviralEmailExamplespipedriveattempt":
			return prompt?.content ?? startviralEmailExamples_prompt;
		case "startviralOpenerEmailSystemPromptLanguagepipedriveattempt":
			return (
				prompt?.content ??
				"startviralOpenerEmailSystemPromptLanguage_promptpipedriveattempt"
			);
...
const startviralFeatures = `${await getPromptContentByType("startviralFeaturespipedriveattempt")}`;
...
const startviralBenefits = `${await getPromptContentByType("startviralBenefitspipedriveattempt")}`;
...
export const startviralGuidelines = `${await getPromptContentByType("startviralGuidelinespipedriveattempt")}`;
/**
...
export const startviralEmailExamples = `${await getPromptContentByType("startviralEmailExamplespipedriveattempt")}`;
/**
...
export const startviralOpenerEmailSystemPromptLanguage = async (
	...
	const template = await getPromptContentByType(
		"startviralOpenerEmailSystemPromptLanguagepipedriveattempt",
	);
