...
const edge_node_schema = z.object({
	id: z.string(),
	shortcode: z.string(),
	...
	edge_media_to_caption: z.object({
		edges: z.array(
			z.object({ node: z.object({ text: z.string() }) }).optional(),
		),
	}),
...
export type MediaItem = z.infer<typeof edge_node_schema>;
const edges_schema = z.array(
	z.object({
		node: edge_node_schema,
	}),
);
...
export type web_profile_type = z.infer<typeof web_profile_schema>;
